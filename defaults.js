...
const DEFAULT_LINKS = {
  dsa: {
    ...
    linked_list: [
      ...
      { urls: ['https://github.com/namanvashistha/dsa/blob/main/06-linked-list/04-remove-nth-node.md', 'https://leetcode.com/problems/remove-nth-node-from-end-of-list/'] },
      ...
      { urls: ['https://github.com/namanvashistha/dsa/blob/main/06-linked-list/08-find-duplicate-number.md', 'https://leetcode.com/problems/find-the-duplicate-number/'] },
    ...
    trees: [
      ...
      { urls: ['https://github.com/namanvashistha/dsa/blob/main/07-trees/02-maximum-depth.md', 'https://leetcode.com/problems/maximum-depth-of-binary-tree/'] },
      { urls: ['https://github.com/namanvashistha/dsa/blob/main/07-trees/03-diameter-of-tree.md', 'https://leetcode.com/problems/diameter-of-binary-tree/'] },
      ...
      { urls: ['https://github.com/namanvashistha/dsa/blob/main/07-trees/07-lowest-common-ancestor.md', 'https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree/'] },
      { urls: ['https://github.com/namanvashistha/dsa/blob/main/07-trees/08-level-order-traversal.md', 'https://leetcode.com/problems/binary-tree-level-order-traversal/'] },
      { urls: ['https://github.com/namanvashistha/dsa/blob/main/07-trees/09-right-side-view.md', 'https://leetcode.com/problems/binary-tree-right-side-view/'] },
      ...
      { urls: ['https://github.com/namanvashistha/dsa/blob/main/07-trees/11-validate-bst.md', 'https://leetcode.com/problems/validate-binary-search-tree/'] },
      { urls: ['https://github.com/namanvashistha/dsa/blob/main/07-trees/12-kth-smallest-in-bst.md', 'https://leetcode.com/problems/kth-smallest-element-in-a-bst/'] },
      { urls: ['https://github.com/namanvashistha/dsa/blob/main/07-trees/13-construct-tree-from-preorder-inorder.md', 'https://leetcode.com/problems/construct-binary-tree-from-preorder-and-inorder-traversal/'] },
      { urls: ['https://github.com/namanvashistha/dsa/blob/main/07-trees/14-binary-tree-max-path-sum.md', 'https://leetcode.com/problems/binary-tree-maximum-path-sum/'] },
      { urls: ['https://github.com/namanvashistha/dsa/blob/main/07-trees/15-serialize-deserialize-tree.md', 'https://leetcode.com/problems/serialize-and-deserialize-binary-tree/'] }
    ],
    tries: [
    ...
    backtracking: [
      ...
      { urls: ['https://github.com/namanvashistha/dsa/blob/main/10-backtracking/08-letter-combinations.md', 'https://leetcode.com/problems/letter-combinations-of-a-phone-number/'] },
    ...
    dp_1d: [
      ...
      { urls: ['https://github.com/namanvashistha/dsa/blob/main/13-dynamic-programming-1d/10-word-break.md', 'https://leetcode.com/problems/word-break/'] },
      { urls: ['https://github.com/namanvashistha/dsa/blob/main/13-dynamic-programming-1d/11-longest-increasing-subsequence.md', 'https://leetcode.com/problems/longest-increasing-subsequence/'] },
